...
<html>
	...
	<body>
						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-right">
										<div class="m-new">
											<a href="../person/news.jsp"><i class="am-icon-bell-o"></i>消息</a>
										</div>
										<div class="m-address">
											<a href="../person/address.jsp" class="i-trigger">我的收货地址</a>
										</div>
									</div>
								</div>
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="../person/order.jsp">全部订单</a>
								</div>
								<ul>
							...
							<div class="user-patternIcon">
								...
								<ul>
									...
									<a href="../person/collection.jsp"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="../images/iconsmall1.png"/><p>我的收藏</p></li></a>
									<a href="../home/home.jsp"><li class="am-u-sm-4"><i class="am-icon-gift am-icon-md"></i><img src="../images/iconsmall0.png"/><p>为你推荐</p></li></a>
									<a href="../person/comment.jsp"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="../images/iconsmall3.png"/><p>好评宝贝</p></li></a>
									<a href="../person/foot.jsp"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="../images/iconsmall2.png"/><p>我的足迹</p></li></a>                                                                        
								</ul>
							</div>
							<!--物流 -->
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li> <a href="../person/change.jsp">退款售后</a></li>
						</ul>
					</li>
					<li class="person">
						<a href="#">我的资产</a>
						<ul>
							<li> <a href="../person/coupon.jsp">优惠券 </a></li>
							<li> <a href="../person/bonus.jsp">红包</a></li>
							<li> <a href="../person/bill.jsp">账单明细</a></li>
						</ul>
					</li>
					...
					<li class="person">
						<a href="#">我的小窝</a>
						<ul>
							<li> <a href="../person/collection.jsp">收藏</a></li>
							<li> <a href="../person/foot.jsp">足迹</a></li>
							<li> <a href="../person/comment.jsp">评价</a></li>
							<li> <a href="../person/news.jsp">消息</a></li>
						</ul>
					</li>
		...
		<div class="navCir">
			...
			<li class="active"><a href="../person/index.jsp"><i class="am-icon-user"></i>我的</a></li>					
		</div>
	</body>
