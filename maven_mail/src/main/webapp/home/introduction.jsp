						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">${commodity.price}</b>  </dd>                                 
								</li>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															<input id="min" class="am-btn am-btn-default" name="${commodity.id}" type="button" value="-" />
															<input id="count" name="" type="text" value="1" style="width:30px;" />
															<input id="add" class="am-btn am-btn-default" name="${commodity.id}" type="button" value="+" />
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									...
									<input type="hidden" id="name" value="${commodity.name}"/>
									<input type="hidden" id="price" value="${commodity.price}"/>
			...
			<div class=tip>
				<div id="sidebar">
					<div id="wrap">
						...
						<div id="shopCart" onclick="javascript:window.location.href='shopcart.jsp';" class="item">
							<a href="#">
							...
							<p id="cart_num" class="cart_num">0</p>
						</div>
